...
@testset "finite-difference weights from fornberg(1988) & fornberg(2020)" begin
    ...
    x = collect(-4:4)
    d, e = MethodOfLines.calculate_weights(order, z, x; dfdx = true)
    @test d ≈ [-2493 / 5488000, -12944 / 385875, -87 / 125, -1392 / 125,
        0, 1392 / 125, 87 / 125, 12944 / 385875, 2493 / 5488000]
    @test e ≈ [-3 / 39200, -32 / 3675, -6 / 25, -96 / 25, -205 / 12,
        -96 / 25, -6 / 25, -32 / 3675, -3 / 39200]
end
