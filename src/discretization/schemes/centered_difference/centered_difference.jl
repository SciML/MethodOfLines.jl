...
"""
function central_difference(D::DerivativeOperator{T,N,Wind,DX}, II::CartesianIndex, s, b, jx, u, ufunc) where {T,N,Wind,DX<:Number}
    j, x = jx
...
function central_difference(D::DerivativeOperator{T,N,Wind,DX}, II::CartesianIndex, s, b, jx, u, ufunc) where {T,N,Wind,DX<:AbstractVector}
    j, x = jx
