...
function run_boundary_test()
    ...
    # 1. UNIFORM CASE (Reference Test)
    # Standard formula coefficients should be: [-3/(2h), 4/(2h), -1/(2h)]
    h_uniform = 0.1
    ...
    # 2. NON-UNIFORM CASE (Core Challenge)
    # Highly clustered at the boundary (h1=0.01), then expanding (h2=0.1)
    ...
    # Rule: The sum of derivative coefficients must always be ZERO (Mass conservation)
