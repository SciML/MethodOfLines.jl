...
- Boundary conditions in time are supplied as initial conditions, not at the end of the simulation interal. If your system requires a final condition, please use a change of variables to rectify this.
...
- Advection terms must appear on the opposite side of the equation to any time derivatives.
