...
## Limitations
  ...
  - WENO is emitted in array (slice) form on both uniform and non-uniform grids, including periodic non-uniform grids. See [Discretization](../MOLFiniteDifference.md).
